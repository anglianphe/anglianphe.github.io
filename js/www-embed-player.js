...
r(Ue,Error);var Ve=new Set,We=0;function Xe(a){var b=y("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0,void 0):(b=be(),b.push([a,"ERROR",void 0,void 0,void 0,void 0]),O("ERRORS",b))}
function Ye(a){var b=y("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0,void 0):(b=be(),b.push([a,"WARNING",void 0,void 0,void 0,void 0]),O("ERRORS",b))}
...
tf("//web.archive.org/web/20200209194134/https://static.doubleclick.net/instream/ad_status.js",a);Ef.push(Bf(function(){Ff||"google_ad_status"in window||(zf("//web.archive.org/web/20200209194134/https://static.doubleclick.net/instream/ad_status.js",a),Ff=!0,O("DCLKSTAT",3))},5E3))}}
...
Y.kebqa="kabukiInfo.earlyBrowseRequestInfo.adopted",Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.upg_player_vis="playerInfo.visibilityState",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y.rcl="mwebInfo.responseContentLength",Y.GetSettings_rid="mwebInfo.getSettingsRequestId",Y.GetTrending_rid="mwebInfo.getTrendingRequestId",Y),si=
"isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),ti={},ui=(ti.mver="MEASUREMENT_VERSION_",ti.pis="PLAYER_INITIALIZED_STATE_",ti.yt_pt="LATENCY_PLAYER_",ti.pa="LATENCY_ACTION_",ti.yt_vst="VIDEO_STREAM_TYPE_",ti),vi="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function wi(a){return!!P("FORCE_CSI_ON_GEL",!1)||Q("csi_on_gel")||!!bi(a).useGel}
...
b=Ie("//web.archive.org/web/20200209194134/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof ld&&b.abort();
return id(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Lf.dispose();a=0;for(var b=Ef.length;a<b;a++){var c=Ef[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}Ef.length=0;yf("//web.archive.org/web/20200209194134/https://static.doubleclick.net/instream/ad_status.js");Ff=!1;O("DCLKSTAT",0);Cd(lj,kj);if(a=jj)a.removeEventListener("onScreenChanged",oj),a.removeEventListener("onLogClientVeCreated",nj),a.removeEventListener("onLogServerVeCreated",pj),a.removeEventListener("onLogVeClicked",qj),a.removeEventListener("onLogVesShown",
rj),a.destroy();mj={}});
...
/*
     FILE ARCHIVED ON 19:41:34 Feb 09, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:20:26 Feb 15, 2020.
...
/*
playback timings (ms):
  RedisCDXSource: 21.336
  exclusion.robots: 0.213
  load_resource: 678.062
  exclusion.robots.policy: 0.198
  esindex: 0.015
  captures_list: 322.871
  PetaboxLoader3.resolve: 131.043 (2)
  LoadShardBlock: 164.498 (3)
  CDXLines.iter: 26.331 (3)
  PetaboxLoader3.datanode: 312.845 (5)
*/